...
func GetPregameInfo(a *valorant.Auth, matchID string) (*PregameMatchResponse, error) {
	resp, err := utils.GetRequest("/pregame/v1/matches/"+matchID, "glz", a)
	if err != nil {
		return nil, err
	}
	respBody := PregameMatchResponse{}
